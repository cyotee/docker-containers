...
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.console\2.3.0.redhat-60024\org.apache.karaf.shell.console-2.3.0.redhat-60024.jar
